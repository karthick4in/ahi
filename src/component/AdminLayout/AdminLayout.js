...
import { BrowserRouter, Routes, Route, Outlet, Link, useParams, NavLink } from "react-router-dom";
                        ...
                        <ul className="app-menu list-unstyled accordion" id="menu-accordion">
                            ...
                            <li className="nav-item has-submenu">
                                ...
                                <div id="submenu-accounts" className="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                    <ul className="submenu-list list-unstyled">
                                        ...
                                        <li className="submenu-item"><NavLink className="submenu-link" to="/acc/ledger_view">Ledger View</NavLink></li>
                            ...
                            <li className="nav-item has-submenu">
                                <a className="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-2" aria-expanded="false" aria-controls="submenu-2">
                                    ...
                                    <span className="nav-link-text">Demo</span>
                                    <span className="submenu-arrow">
                                        <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                        </svg>
                                ...
                                <div id="submenu-2" className="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                    <ul className="submenu-list list-unstyled">
                                        <li className="nav-item">
                                            ...
                                            <NavLink className="nav-link" to={"/view/home"}>
                                                <span className="nav-icon">
                                        ...
                                        <li className="submenu-item"><NavLink className="submenu-link" to="/acc/ledger_list">Ledger List
                                            <span className=" btn-primary float-end">+</span>
                                        </NavLink>
                                        </li>
